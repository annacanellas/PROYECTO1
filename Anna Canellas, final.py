...
# Se concluye que el mejor modelo de predicción es el rfr con un R2 de 0,985.
...
# Se decidie realizar K-means para observar si las variables del dataset se pueden agrupar, y en consecuencia, hacer predicciones para cada cluster con el fin de mejorar la predicción del modelo
